...
const blogModal = document.querySelector('blog__modal__body'); //Card Modal
...
const editCard = (event) => {
    ...
    blogTitle.setAttribute("contenteditable","ture");
    blogDescription.setAttribute("contenteditable","ture");
    blogType.setAttribute("contenteditable","ture");
